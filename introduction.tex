...
\begin{enumerate}
    \item we describe the EEG signal broadly,
    \item then we describe the datasets and methods used in this work,
    \item we provide the results
    \item and ablation studies.
\end{enumerate}.