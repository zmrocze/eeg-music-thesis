...
The results are shown in the below table. For the CNN model we can't achieve reasonable accuracy, so we omit it. We expect the big number of labels to be the culprit.
...
For comparison the results of the other models range from 0.57\% to 0.85\% and random chance is 0.08\%.
...
Below figure shows an example ODF prediction.
