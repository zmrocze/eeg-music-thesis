...
The results are shown in Table~\ref{tab:song-id-single-subject}. For the CNN model we can't achieve reasonable accuracy, so we omit it. We expect the big number of labels to be the culprit.
